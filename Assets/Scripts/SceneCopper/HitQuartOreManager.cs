...
public class HitQuartOreManager : MonoBehaviour
{
    [SerializeField]
    GameObject quartOrePrefab;
    public int durable; // 7
    ...
    /// <summary>
    /// It spawns an Item gameobject position.
    /// </summary>
    private void DropItem()
    {
        Vector3 spawnPoint = new Vector3(transform.position.x, transform.position.y, -1f);
        Instantiate(quartOrePrefab, spawnPoint, Quaternion.identity);
